...
import com.infranics.iot.facility.config.FacilityStatusProperties;
...
public class DeviceMessageDispatcher {
    ...
    private static final Set<String> INTERPHONE_CALL_REQUEST_CMDS = Set.of("0xA1");
    ...
    private final FacilityStatusProperties facilityStatusProperties;
    ...
    public DeviceMessageDispatcher(PendingCommandTracker pendingCommandTracker,
                                    ...
                                    FacilityStatusProperties facilityStatusProperties
                                    ) {
        ...
        this.facilityStatusProperties=facilityStatusProperties;
    ...
    public void onMqttMessage(MqttMessageReceivedEvent event) {
        ...
        log.debug("isCallRequest(deviceType, cmd) ={},{},{}",isCallRequest(deviceType, cmd),deviceType,cmd);
     ...
     // 3-1. 인메모리 업데이트
        ...
        if(facilityStatusProperties.historySaveEnabled())
    ...
    private boolean isCallRequest(DeviceType deviceType, String cmd) {
        ...
        return switch (deviceType) {
            case INTERPHONE -> INTERPHONE_CALL_REQUEST_CMDS.contains(cmd);
            case ACCESS -> ACCESS_CALL_REQUEST_CMDS.contains(cmd);
            default -> false;
        };
    }
